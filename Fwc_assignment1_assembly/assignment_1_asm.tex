...
\\ 5) Write the assembly code for the above boolean expression using registers and instruction set format and upload the code in to the arduino using geany.
\vspace{10mm}
...
\begin{lstlisting}
https://github.com/Mannava123455/Mannava-Venkatasai/blob/main/FWC_assignment_1_Mannava_Venkatasai/codes/src/main.cpp
\end{lstlisting}
\end{document}